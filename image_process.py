...
def get_transmittance(img_path, seg_path, kernel_size, border, binary_type = "brightness", model = 'segbin'):
    if model == 'segbin':
...
def get_transmittance_center_of_modes(img_path, seg_path, kernel_size, binary_type = "brightness", model = 'segbin', type = "q2"):
    if model == 'segbin':
        img = Image.open(img_path)
        # Split the image into R, G, B components
        r, g, b = img.split()
...
def get_transmittance_center_of_modes_upper(img_path, seg_path, kernel_size, binary_type = "brightness", model = 'segbin', type = "q2"):
    if model == 'segbin':
        img = Image.open(img_path)
        # Split the image into R, G, B components
        r, g, b = img.split()
